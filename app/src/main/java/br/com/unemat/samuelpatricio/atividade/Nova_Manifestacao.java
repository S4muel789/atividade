...
public class Nova_Manifestacao extends AppCompatActivity {
                ...
                public void onClick(View v) {
                    ...
                    if (!descricao.isEmpty()) {
                        try {
                            ...
                            Intent intent = new Intent(Nova_Manifestacao.this, MunicipioFato.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(Nova_Manifestacao.this,
